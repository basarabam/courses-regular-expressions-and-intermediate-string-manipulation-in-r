...
`@part1`
Instead of replacing with a fixed string, you can use **backreferences** to insert components of the match. In the following code example, the order of the second and third words is flipped
```
