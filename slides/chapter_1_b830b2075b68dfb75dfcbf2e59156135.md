...
``` 
string <- c("football", "basketball", "tennis", “voleyball“)
pattern = "[aeiou]"
replacement = "_"
...
[1] "_ootball"   "_asketball" "_ennis"     "_oleyball"{{2}}
```
...
`@script`
With str_replacement functions you can use functions to do replacements, in this case to convert all vowels to upper case. 
Also it is possible replace vowels with NA values, like in the example.
...
`@script`
OK, it is time to implement your new replacing knowledge. Go fot it!!!
