...
Input vector - Usually character vector
Pattern - Pattern can be a string or regular expression.
...
`@script`
So, it is time to implement your new knowledge. Happy stringing!!!
