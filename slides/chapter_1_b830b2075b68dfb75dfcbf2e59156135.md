...
Pattern as a second argument in a form of string or regular expression.
Replacement as a third argument in a form of character vector, name vector or function. 
...
`@script`
In the following example, the order of the second and third word is flipped, with backreference what would be discussed in the next chapter of these course.
This is example of efuse of regular expressions.
