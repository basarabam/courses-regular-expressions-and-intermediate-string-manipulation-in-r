...
Suddenly, your task is changed and you have to remove consonants from the sting. No problem you can use negation in regular expression syntax, and do it with one key stroke.
